...
const AdminHeaderLinks = () => {
    return (
        <div className='w-[18%]'>
            ...
            <Link className='text-[20px] w-full text-black font-semibold py-[15px] px-[15px]  hover:bg-blue-500 hover:text-white transition-all inline-block border-[1px] border-black' to='Admin-ProductCatalogImg'>Endirim Kataloq</Link>
        </div>
    )
}
