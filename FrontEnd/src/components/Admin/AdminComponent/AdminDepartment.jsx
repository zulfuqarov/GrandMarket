...
const AdminDepartment = () => {
  ...
  const addDeparment = async () => {
    try {
      ...
      fileUpload.append("PartnerImg", Image)
      fileUpload.append("PartnerName", Input.Name)
      fileUpload.append("PartnerPosition", Input.Position)
      const res = await axios.post(`${env.REACT_APP_BACKEND_HOST}/Partner/AddPartner`, fileUpload)
  ...
  return (
    <div className='w-[85%]'>
      <h1 className='text-center text-[26px] text-blue-600 font-bold'>Department Əlavəsi</h1>
