...
const AboutMission = () => {
    return (
        <div className='container mx-auto pt-[80px]'>
            <h1 className='text-[42px] text-center font-semibold text-black max-[768px]:text-[28px]'>Keyfiyyət standartlarımız</h1>
            <section className=' pt-[40px] grid grid-cols-3 gap-4 max-[1024px]:grid-cols-2  max-[768px]:grid-cols-1 '>
                <div className='bg-black rounded-lg p-[50px] h-[450px] max-[1280px]:h-[500px]  max-[768px]:h-full  shadow-lg shadow-black'>
                    <h1 className='text-[22px] font-semibold text-blue-500 tracking-normal max-[768px]:text-[20px]	pb-[35px]'>Komfortlu alış-veriş üçün hər şərait</h1>
                ...
                <div className='bg-black rounded-lg p-[50px] h-[450px] max-[1280px]:h-[500px]  max-[768px]:h-full shadow-lg shadow-black'>
                    <h1 className='text-[22px] font-semibold text-blue-500 tracking-normal max-[768px]:text-[20px]	pb-[35px]'>Mağaza standartlarında mükəmməllik</h1>
                ...
                <div className='max-[1024px]:col-span-full mx-auto max-[768px]:col-span-1 max-[768px]:mx-0 '>
                    <div className='bg-black rounded-lg p-[50px] h-[450px] max-[1280px]:h-[300px] shadow-lg shadow-black'>
                        <h1 className='text-[22px] font-semibold text-blue-500 tracking-normal max-[768px]:text-[20px] 	pb-[35px]'>Qüsursuz xidmət</h1>
